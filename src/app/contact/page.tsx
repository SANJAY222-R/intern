        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="flex flex-col justify-center">
            <h1 className="text-5xl md:text-6xl font-heading font-bold mb-6 leading-tight">
              Deploy AI Inside Your <span className="text-purple-400">Enterprise</span>.
            </h1>
            ...
            <AnimatedCard className="bg-[#0A0A0A] border border-neutral-800 p-8 md:p-10 font-mono">
              {isSuccess ? (
                ...
                >
                  ...
                  <h3 className="text-2xl font-sans font-bold mb-4 text-white">Request Received</h3>
                  <p className="text-neutral-400 mb-8 font-sans">An Enterprise Architect will review your submission and contact you within 24 hours.</p>
                  <button onClick={() => setIsSuccess(false)} className="text-purple-400 hover:text-white transition-colors underline font-sans text-sm">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6" suppressHydrationWarning>
                  ...
                  <div className="space-y-2">
                    <label className="text-xs uppercase tracking-widest font-semibold text-neutral-500">Project Description & Core Challenges</label>
                    <textarea
                  ...
                  <p className="text-center font-sans text-xs text-neutral-600 mt-4">Your information is protected by our strict enterprise privacy policy.</p>
                </form>
              )}
            </AnimatedCard>
          </div>
